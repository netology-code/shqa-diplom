...
- тестовая сборка Android ([apk-файл](https://github.com/netology-code/shqa-diplom/releases)) (apk-файл находится в релизах этого репозитория, залогиньтесь в GitHub, чтобы получить доступ к скачиванию);
